...
public class Quiz2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Congrats That was Correct");

        jLabel2.setFont(new java.awt.Font("Tekton Pro", 0, 18)); // NOI18N
        jLabel2.setText("What is a Good Matchup for a Range Champion ");

        Answer1.setText("Melee");

        Answer3.setText("Poke/Roam");

        Answer4.setText("Burst");

        Answer2.setText("All of Them");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         QuestionResponce(); // Executing the Method
    }//GEN-LAST:event_jButton1ActionPerformed

    /**
     * @param args the command line arguments
     */
    public void QuestionResponce(){ //The Method
     ...
     if(Answer1.isSelected()){ // Wrong Anser
         Wrong.setText("That is Incorrect, please try again");
     }
     if(Answer2.isSelected()){ // Right Anser
          new Quiz3().setVisible(true);
        this.setVisible(false);
     }
     if(Answer4.isSelected()){ // Wrong Anser
         Wrong.setText("That is Incorrect, please try again");
     }
     if(Answer3.isSelected()){ // Wrong Anser
         Wrong.setText("That is Incorrect, please try again");
     }
    }
